...
sed -i "s/OpenWrt /OpenWrt_x64_bing by GXNAS build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ_PATH
...
mv openwrt-x86-64-generic-squashfs-combined.img.gz OpenWrt-x64_bing.img.gz
EOF
