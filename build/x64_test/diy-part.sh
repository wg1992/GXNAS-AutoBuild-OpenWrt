...
# 添加istore应用商店
#svn checkout https://github.com/linkease/istore/tree/main/luci/luci-app-store package/luci-app-store
#svn checkout https://github.com/linkease/istore-ui/tree/main/app-store-ui package/store-ui
git clone https://github.com/linkease/istore package/luci-app-store
git clone https://github.com/linkease/istore-ui package/store-ui
